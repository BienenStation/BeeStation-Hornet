...
/obj/item/cartridge
	...
	desc = "Eine Datenkassette für tragbare Mikrocomputer."
...
/obj/item/cartridge/lawyer
	name = "\improper P.R.O.V.E. Karte"
	icon_state = "cart-s"
	access = CART_SECURITY
	spam_enabled = 1

/obj/item/cartridge/curator
	name = "\improper Lib-Tweet Karte"
	icon_state = "cart-s"
	access = CART_NEWSCASTER

/obj/item/cartridge/roboticist
	name = "\improper B.O.O.P. Remote Control Karte"
...
/obj/item/cartridge/signal
	name = "generic signaler Karte"
	desc = "A data cartridge with an integrated radio signaler module."

/obj/item/cartridge/signal/toxins
	name = "\improper Signal Ace 2 Karte"
...
/obj/item/cartridge/quartermaster
	name = "space parts & space vendors Karte"
...
/obj/item/cartridge/head
	name = "\improper Easy-Record DELUXE Karte"
	icon_state = "cart-h"
	access = CART_MANIFEST | CART_STATUS_DISPLAY

/obj/item/cartridge/hop
	name = "\improper HumanResources9001 Karte"
	icon_state = "cart-h"
...
/obj/item/cartridge/hos
	name = "\improper R.O.B.U.S.T. DELUXE Karte"
	icon_state = "cart-hos"
