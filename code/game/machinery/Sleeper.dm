...
/obj/machinery/sleeper
	name = "sleeper"
	desc = "Eine geschlossene Maschine, die zur Stabilisierung und Heilung von Patienten eingesetzt wird."
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper"
	density = FALSE
	state_open = TRUE
...
/obj/machinery/sleeper/container_resist(mob/living/user)
	visible_message("<span class='notice'>[occupant] entspringt aus [src]!</span>",
...
/obj/machinery/sleeper/default_pry_open(obj/item/I) //wew
	...
	if(.)
		...
		visible_message("<span class='notice'>[usr] pries open [src].</span>", "<span class='notice'>Du brichst [src] auf.</span>")
		open_machine()
